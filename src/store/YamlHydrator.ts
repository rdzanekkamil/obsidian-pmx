...
export function hydrateVersions(raw: unknown[]): Version[] {
  ...
  return raw
    ...
    .map((r) => {
      ...
      return {
        ...
        plannedReleaseDate: (v.plannedReleaseDate as string) ?? '',
        releasedAt: (v.releasedAt as string) ?? '',
        taskIds: Array.isArray(v.taskIds) ? [...(v.taskIds as string[])] : [],
